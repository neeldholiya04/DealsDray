...
const CreateEmployeeForm = () => {
  ...
  return (
    <Form layout="vertical" onFinish={onFinish}>
      ...
      <Form.Item label="Email" name="email" rules={[{ required: true, message: 'Please enter employee email' }, { type: 'email', message: 'Please enter a valid email' }]}>
      ...
      <Form.Item label="Role" name="role" rules={[{ required: true, message: 'Please select employee role' }]}>
      ...
      <Form.Item label="Designation" name="designation" rules={[{ required: true, message: 'Please enter employee designation' }]}>
        <Input placeholder="Enter employee designation" />
      </Form.Item>

      <Form.Item label="Gender" name="gender" rules={[{ required: true, message: 'Please select employee gender' }]}>
      ...
      <Form.Item label="Course" name="course" rules={[{ required: true, message: 'Please enter employee course' }]}>
        <Input placeholder="Enter employee course" />
      </Form.Item>

      <Form.Item label="Image Link" name="img_link" rules={[{ required: true, message: 'Please enter employee image link' }]}>
